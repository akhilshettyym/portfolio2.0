                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm animate-fade-in">
                    <div className="w-full max-w-sm bg-white p-6 shadow-xl border border-gray-100 transform transition-all scale-100">
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                            Are you sure you want to delete this lead permanently? This action
                            cannot be undone.
                        </p>

                        <div className="mt-6 flex justify-end gap-3">
                            <button onClick={() => setIsModalOpen(false)} className="border border-black/60 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors">{" "}Cancel{" "}
                            </button>
