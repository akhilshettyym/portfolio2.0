      ...
      <body className="min-h-screen flex flex-col bg-white text-black antialiased">
        {!isLoginPage && (
          <nav className="w-full border-b border-black py-5 px-6 flex justify-between items-center bg-white">
            ...
            <button onClick={handleLogout} className="border-2 border-black px-4 py-2 text-sm uppercase font-mono tracking-normal hover:bg-black hover:text-white transition-colors duration-150"> Logout </button>
          </nav>
        )}
