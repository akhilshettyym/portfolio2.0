...
const MarqueeLineLow = ({ text, large }) => {
...
const FooterComponent = () => {
    ...
    const renderTierTwoFooter = () => {
        return (
            <motion.section ref={sectionRef} className="relative w-full bg-white text-black">
                            ...
                            <div className="mb-5 flex h-[75vh] w-full flex-col gap-4 md:flex-row">
                                <div className="w-full text-white md:w-[60%]">
                                    <div className="flex h-full w-full flex-col gap-4">
                                        <div className="flex flex-1 items-center justify-center p-4 text-indigo-900">
                                            <div className="overflow-hidden">
                                                <MarqueeLineLow large={true} text="CREATIVELY" />
                                                <MarqueeLineLow text="DRIVEN DESIGNER & DEVELOPER." />
                                            </div>
                                        </div>
                                        ...
                                        <div className="relative flex-1 overflow-hidden rounded-xl bg-gray-200 p-6 text-black">
                                            <div className="flex h-full w-full flex-col gap-4">
                                                ...
                                                <div className="flex-1 rounded-lg">
                                                    <p className="text-balance text-[15px] text-black/80 justify-text">
    ...
    const render = () => {
        return isTier2 ? renderTierTwoFooter() : renderTierOneFooter();
    };
