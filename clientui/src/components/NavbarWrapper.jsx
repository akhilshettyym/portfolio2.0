...
const NavbarWrapperComponent = ({ children }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 w-full z-50 transition-opacity duration-300 ${navReady ? "opacity-100 animate-navbar-enter" : "opacity-0 pointer-events-none"}`}>
