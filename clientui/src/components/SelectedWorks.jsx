      ...
      <div className="mx-auto max-w-[1600px] px-10 py-10">
        <div className="mb-5">
          ...
          <div className="overflow-hidden">
            <h1 className="inline-block origin-left text-[clamp(4.0rem,9vw,4.0rem)] font-black leading-[0.7] tracking-[-0.09em] text-black will-change-transform" style={{ fontFeatureSettings: '"ss01" on, "ss02" on', transform: "scaleX(1.5)" }}>
              SELECTED /
            </h1>
          </div>

          <div className="-mt-3 overflow-hidden">
            <h1 className="flex w-full items-baseline justify-between whitespace-nowrap text-[clamp(4rem,5vw,2rem)] font-black leading-[0.82] tracking-[-0.09em] text-black/90 will-change-transform" style={{ fontFeatureSettings: '"ss01" on, "ss02" on' }}>
              <span>. WORKS</span>
              <span className="ml-auto mr-5 text-sm tracking-normal">
                {" "}24-26{" "}
              </span>
            </h1>
          </div>
            ...
            return (
              <motion.div key={project.id} role="button" tabIndex={0}
                ...
                <div className="grid grid-cols-12 gap-6 px-10 py-6">
                  ...
                  <div className="col-span-6 md:col-span-2">
                    <p className="mb-2 text-xs uppercase opacity-60">
                      {" "}Category{" "}
                    </p>
...
function FloatingProjectPreview({ project, cardAnchor, buttonAnchor, onHold, onRelease }) {
  ...
  const springCardX = useSpring(cardX, {
    stiffness: 180,
    damping: 24,
    mass: 0.9,
  });

  const springCardY = useSpring(cardY, {
    stiffness: 180,
    damping: 24,
    mass: 0.9,
  });
