        ...
        <div className={`flex items-center justify-center ${padding} ${className}`} {...props}>
            <div className="relative rounded-[2.5rem] shadow-2xl border border-white/40 backdrop-blur-md" style={{ width, height }}>
                <div className="absolute inset-0 overflow-hidden rounded-[2.5rem]">
                    ...
                    {!isTier2 && (
                        <Canvas frameloop="demand" dpr={[1, 1.15]} camera={{ position: [0, 0, 9], fov: 46 }} gl={{ alpha: true, antialias: false, toneMapping: THREE.ACESFilmicToneMapping, toneMappingExposure: 1.15 }} style={{ background: "transparent" }}>
