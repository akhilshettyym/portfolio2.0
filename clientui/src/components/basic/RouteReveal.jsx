...
//                         transition={{ duration: isTier2 ? 0.72 : 1.08, times: [0, 0.38, 0.62, 1], ease: [0.77, 0, 0.175, 1] }}
...
//                             <motion.div initial={{ opacity: 0, scale: 0.94 }}
...
const RouteReveal = () => {
    // Page transition animations have been removed for performance optimization
    return null;
};
