...
export default function BubbleScene() {
    ...
    useEffect(() => {
        ...
        const texture1 = loader.load("/bubble2.png");
        const texture2 = loader.load("/bubble2.png");
                    ...
                    intersects.forEach((hit) => {
                        if (hit.object === bubble) {
                            ...
                            gsap.to(bubble.scale, {
                                x: bubble.userData.radius * 3,
                                y: bubble.userData.radius * 3,
                                duration: 0.2,
                            });
                        }
                    });
