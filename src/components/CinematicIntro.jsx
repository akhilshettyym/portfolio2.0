            ...
            return (
                <SceneShell dark={false}>
                    ...
                    <motion.div initial={{ opacity: 0, scale: 1.03, filter: "blur(16px)" }}
                        animate={{ opacity: timelineReveal ? 1 : 0, scale: timelineReveal ? 1 : 1.03, filter: timelineReveal ? "blur(0px)" : "blur(16px)" }} transition={{ duration: 1.15, ease: [0.77, 0, 0.175, 1] }} className="flex h-full w-full flex-col overflow-hidden">
