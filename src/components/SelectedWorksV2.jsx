            ...
            <div className="mx-auto max-w-[1600px] px-6 py-24 md:px-12">
                <div className="mb-5">
                    ...
                    <div className="overflow-hidden">
                        <h1
                            className="inline-block origin-left text-[clamp(4.0rem,9vw,4.0rem)] font-black leading-[0.7] tracking-[-0.09em] text-black will-change-transform"
                            style={{
                    ...
                    <div className="-mt-3 overflow-hidden">
                        <h1
                            className="flex w-full items-baseline justify-between whitespace-nowrap text-[clamp(4rem,5vw,2rem)] font-black leading-[0.82] tracking-[-0.09em] text-black/90 will-change-transform"
                            style={{
                                fontFeatureSettings: '"ss01" on, "ss02" on',
                            }}
                        >
                    ...
                    {PROJECTS.map((project, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="group relative cursor-pointer border-t border-black outline-none"
                            >
                                <div className="grid grid-cols-12 gap-6 px-10 py-6">
                                    ...
                                    <div className="col-span-6 md:col-span-2">
                                        <p className="mb-2 text-xs uppercase opacity-60">Type</p>
                            ...
                            <>
                                ...
                                <div className="absolute inset-0 flex flex-col justify-between p-7 text-white">
                                    ...
                                    <div>
                                        ...
                                        <p className="mt-4 max-w-[580px] text-sm leading-relaxed text-white/80">
                                            {project.description}
                                        </p>
                ...
                >
                    ...
                    >
                        <Link
                            ...
                            className="inline-flex h-[52px] items-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-medium text-black shadow-[0_20px_40px_rgba(0,0,0,0.2)] transition-transform duration-300 hover:scale-[1.04] active:scale-[0.98]"
                        >
                            Visit Live Site
