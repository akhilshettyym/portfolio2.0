              ...
              <div className="mb-5 flex h-[20vh] w-full gap-2 bg-gray-300 p-2">
                <div className="flex h-full w-[20%] flex-col rounded-md border border-slate-200 bg-white p-4 text-black shadow-sm">
                  ...
                  <Image
                    ...
                    priority
                    unoptimized
                    className="mt-auto object-contain mix-blend-multiply"
                  />
                </div>
              ...
              <div className="absolute top-5 right-5 z-10">
                <button
                  ...
                  <Image
                    ...
                    priority
                    unoptimized
                    className="h-[0.95em] w-auto object-contain mix-blend-multiply opacity-80"
                  />
                </button>
              </div>
    ...
    return (
      <motion.section ref={sectionRef} className="relative z-50 w-full bg-white text-black overflow-hidden">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <motion.div
            style={{ opacity: glowOpacity }}
            className="absolute left-1/2 top-10 h-96 w-96 -translate-x-1/2 rounded-full bg-white blur-3xl sm:h-184 sm:w-184 lg:h-128 lg:w-lg"
          />

          <motion.div
            style={{ opacity: gridOpacity }}
            className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.08)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.08)_1px,transparent_1px)] bg-size-[48px_48px] sm:bg-size-[64px_64px]"
          />
