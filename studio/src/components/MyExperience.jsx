  ...
  return (
    <div
      className={`absolute inset-0 w-full h-full transition-opacity duration-500 ${
        isActive ? "opacity-100 z-10" : "opacity-0 z-0 pointer-events-none hidden-layer"
      }`}
    >
    ...
    <div className="experience-wrapper" style={{ height: `${COMPONENT_HEIGHT}` }}>
      <div className="controls">
        <LiquidGlass width="65px" height="40px" padding="p-0">
          <button
            className="flex items-center justify-center w-full h-full text-sm font-medium tracking-wide text-zinc-500 transition-colors duration-200 hover:text-zinc-700 pb-6"
        ...
        <LiquidGlass width="200px" height="40px" padding="p-0">
          <button
            className="flex items-center justify-center w-full h-full text-xs font-bold tracking-wider text-zinc-600 transition-colors duration-200 hover:text-zinc-900 uppercase pb-6"
            onClick={toggleLogSource}
          >
            <span>
              ...
              return (
                <div key={idx} className="card-wrapper">
                  ...
                  <div className="card card-ascii">
                    <div
                      className={`ascii-content transition-opacity duration-500 ${activeLog === "experience" ? "opacity-100" : "opacity-0 absolute pointer-events-none"}`}
                    >
                      {experienceAsciiCards[currentCardIndex]}
                    </div>
                    <div
                      className={`ascii-content transition-opacity duration-500 ${activeLog === "education" ? "opacity-100" : "opacity-0 absolute pointer-events-none"}`}
                    >
