...
//   useEffect(() => {
//     if (!sceneAssets && !isControlled) {
//       setInternalOpen(false);
//     }
//   }, [sceneAssets, isControlled]);
...
//   return (
//     <div ref={containerRef} className="pointer-events-auto fixed right-11 top-32 z-99999 h-8 w-8">
//       <AnimatePresence>
//         {open && (
//           <>
//             {renderControl(
...
//                     <motion.span
//                       animate={{
//                         rotate: sceneCondition === "storm" ? [-6, 6, -6] : 0,
//                       }}
//                       transition={{
//                         duration: 1.2,
...
//                     <motion.span
//                       animate={{
//                         y: moonPhase === "FULL_MOON" ? [0, -1.5, 0] : 0,
//                       }}
//                       transition={{
//                         duration: 2.2,
...
//             }
//           }}
//           className={`album mini absolute left-1/2 top-1/2 z-100 -translate-x-1/2 -translate-y-1/2 cursor-pointer outline-none ${
//             open ? "open" : ""
//           }`}>
//           <div className="album-cover">
//             <img src={triggerCover} alt="" />
//           </div>
    ...
    >
      ...
      {!isControlled && (
        <div
          ...
          className={`album mini absolute top-1/2 left-1/2 z-[100] -translate-x-1/2 -translate-y-1/2 cursor-pointer outline-none ${
            open ? "open" : ""
          }`}
        >
          <div className="album-cover">
          ...
          <div className="album-vinyl">
            <div
              ...
              style={{
                backgroundImage: `url("${triggerCover}")`,
              }}
            />
          </div>
        </div>
...
function ControlLabel({ label, labelPlacement }) {
  const placementClass =
    labelPlacement === "left"
      ...
      : "top-full left-1/2 mt-1 -translate-x-20";
