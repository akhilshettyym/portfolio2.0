  ...
  return (
    ...
    >
      <button
        ...
        aria-label="Hire me"
        className={`flex w-10 flex-col items-center justify-center gap-1 border py-4 text-[10px] font-bold uppercase rounded-3xl tracking-[0.1em] transition-transform duration-150 ease-out hover:scale-105 ${hireButtonTheme}`}
      >
